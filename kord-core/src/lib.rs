...
#[no_mangle]
pub extern "C" fn kord_get_settings() -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn kord_save_settings(json: *const c_char) -> bool {
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_reset_settings() -> *mut c_char {
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_list_audio_devices() -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn kord_start_recording(
    device: *const c_char,
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_stop_recording() -> *mut c_char {
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_stop_and_process() -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn kord_get_recording_state() -> bool {
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_transcribe(
    samples: *const f32,
    len: usize,
    rate: u32,
) -> *mut c_char {
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_list_whisper_models() -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn kord_download_whisper_model(name: *const c_char) -> bool {
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_get_download_progress() -> *mut c_char {
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_optimize_prompt(transcript: *const c_char) -> *mut c_char {
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_list_llm_models() -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn kord_download_llm_model(name: *const c_char) -> bool {
    let name = match unsafe { c_str_to_str(name) } {
        Some(s) => s,
        None => return false,
    };
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_get_llm_download_progress() -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn kord_delete_whisper_model(name: *const c_char) -> bool {
    let name = match unsafe { c_str_to_str(name) } {
        Some(s) => s,
        None => return false,
    };
...
#[no_mangle]
pub extern "C" fn kord_delete_llm_model(name: *const c_char) -> bool {
    let name = match unsafe { c_str_to_str(name) } {
        Some(s) => s,
        None => return false,
    };
...
/// Caller must free the returned string with kord_free_string().
#[no_mangle]
pub extern "C" fn kord_get_history(limit: i32, offset: i32) -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn kord_delete_history_entry(id: *const c_char) -> bool {
...
#[no_mangle]
pub extern "C" fn kord_clear_history() -> bool {
...
#[no_mangle]
pub extern "C" fn kord_paste_text(text: *const c_char) -> bool {
...
#[no_mangle]
pub extern "C" fn kord_free_string(ptr: *mut c_char) {
    if !ptr.is_null() {
        unsafe {
