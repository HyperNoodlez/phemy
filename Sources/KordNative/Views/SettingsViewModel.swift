...
final class SettingsViewModel: ObservableObject {
    ...
    func downloadWhisperModel(_ name: String) {
        ...
        Task.detached {
            let success = KordCore.shared.downloadWhisperModel(name: name)
    ...
    func downloadLlmModel(_ name: String) {
        ...
        Task.detached {
            let success = KordCore.shared.downloadLlmModel(name: name)
